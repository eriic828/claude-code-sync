---
name: ecc-council
description: Four-voice decision council for ambiguous decisions, tradeoffs, and go/no-go calls. Convenes Architect, Skeptic, Pragmatist, and Critic voices in parallel. Anti-anchoring mechanism prevents conversational bias.
---
...
This is the **anti-anchoring mechanism** — prevents conversational bias by launching independent subagents with fresh context, not the full conversation history.
